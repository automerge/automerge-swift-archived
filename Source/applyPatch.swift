...
//    switch patch.type {
//    case .map:
//        result = updateMapObject(patch: patch, obj: obj, updated: &updated)
//    case .table:
//        result = updateTableObject(patch: patch, obj: obj, updated: &updated)
//    case .list:
//        result = updateListObject(patch: patch, obj: obj, updated: &updated)
//    case .text:
//        result = updateTextObject(patch: patch, obj: obj, updated: &updated)
//    }
//
//    return result
//}
...
//    let objectId = patch.objectId
//    var object = obj ?? cloneListObject(originalList: obj, objectId: objectId)
...
//    originalObject[CONFLICTS] = originalObject[CONFLICTS] ?? [Key: [String: Any]]()
